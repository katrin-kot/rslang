...
export default () => {
  const form = `
    ...
    <p><strong>Выберите уровень сложности слов:</strong></p>
     ...
     <br>
     <input id="radio-difficult-3" name="difficult" type="radio" value="2">
     <label class="label-difficult" for="radio-difficult-3">Лёгкий</label>
     <br>
     <input id="radio-difficult-4" name="difficult" type="radio" value="3">
     <label class="label-difficult" for="radio-difficult-4">Средний</label>
     <br>
     <input id="radio-difficult-5" name="difficult" type="radio" value="4">
     <label class="label-difficult" for="radio-difficult-5">Сложный</label>
     <br>
     <input id="radio-difficult-6" name="difficult" type="radio" value="5">
